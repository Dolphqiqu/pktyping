...
class ShareManager: NSObject, UIDocumentInteractionControllerDelegate {
    ...
    func sendToMail(vc: UIViewController) {
        ...
        if MFMailComposeViewController.canSendMail() {
            ...
            composer.setToRecipients(["wayi1802077@mail.ru"])
            composer.setSubject("yabotyper App")
    ...
    //MARK: App Stor rate
    func appStoreRate() {
        guard let url = URL(string : "itms-apps://itunes.apple.com/us/app/id1479369383") else { return }
    ...
    func otherShare(vc: UIViewController) {
        let image = #imageLiteral(resourceName: "yabotyperlogo")
