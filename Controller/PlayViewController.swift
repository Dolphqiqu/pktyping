...
class PlayViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
       ...
       // switchView.choiceView.setGradientBackground()
        switchView.choiceView.backgroundColor = UIColor.init(red: 238/255.0, green: 177/255.0, blue: 115/255.0, alpha: 1.0)
    }
    ...
    func showAlert() {
        let alert = UIAlertController(title: "Sorry", message: "Coming soon, we are working hard...", preferredStyle: UIAlertControllerStyle.alert)
