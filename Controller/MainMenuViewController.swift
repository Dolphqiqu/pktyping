...
class MainMenuViewController: UIViewController {
    ...
    lazy var nameLabel: UILabel = {
        ...
        label.setTextWithTypeAnimation(typedText: " yabotype")
    ...
    override func viewDidLoad() {
        ...
        Music.share.playBackgroundMusic(filename: "buttflysound")
    }
    ...
    func configureConstraints(){
        ...
        constrain(nameLabel, view){ nl, v in
            ...
            nl.width == Constant.multiplyToWidth(number: 320)
        }
    ...
    @objc func soundPressed(){
        if isPressed {
            ...
            menuView.soundImageView.image = #imageLiteral(resourceName: "soundOn")
            isPressed = true
        }
    }
